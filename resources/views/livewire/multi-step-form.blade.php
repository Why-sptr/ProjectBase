            ...
            <div class="row" style="margin-top: 100px;">
                <div class="col">
                    ...
                    <div class="md-form md-outline input-with-post-icon datepicker" id="accLabels">
                        ...
                        <input placeholder="Select date" type="date" placeholder="Pilih Jadwal Pengiriman" id="date" style="min-height: 60px; border-radius: 20px;" class="form-control" wire:model="rencana_kirim">
            ...
            <div class="row" style="margin-top: 100px;">
                ...
                <div class="col">
                    ...
                    <div>
                        <p>Total Harga</p>
                        @if ($harga !== null)
                        <h1>Rp. {{ number_format($harga->harga, 0, ',', '.') }}</h1>
                        @else
