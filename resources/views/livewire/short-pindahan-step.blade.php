        ...
        <div>
            ...
            <div class="row" style="margin-top: 100px;">
                <div class="col">
                            ...
                            <td>
                                <div class="mb-3">
                                    <fieldset disabled>
                                        ...
                                        <input type="text" id="disabledTextInput" style="min-height: 60px; border-radius: 20px; background-color: #d6d6d6;" class="form-control" placeholder="Disabled input" wire:model="origin_provinsi">
                            ...
                            <td>
                                <div class="mb-3">
                                    <fieldset disabled>
                                        ...
                                        <input type="text" id="disabledTextInput" style="min-height: 60px; border-radius: 20px; background-color: #d6d6d6;" class="form-control" placeholder="Disabled input" wire:model="origin_kabupaten">
                            ...
                            <td>
                                <div class="mb-3">
                                    <fieldset disabled>
                                        ...
                                        <input type="text" id="disabledTextInput" style="min-height: 60px; border-radius: 20px; background-color: #d6d6d6;" class="form-control" placeholder="Disabled input" wire:model="origin_kecamatan">
                            ...
                            <td>
                                <div class="mb-3">
                                    <fieldset disabled>
                                        ...
                                        <input type="text" id="disabledTextInput" style="min-height: 60px; border-radius: 20px; background-color: #d6d6d6;" class="form-control" placeholder="Disabled input" wire:model="origin_kelurahan">
                    ...
                    <div class="mb-3">
                        ...
                        <input style="min-height: 60px; border-radius: 20px; background-color: #d6d6d6;" class="form-control" type="text" placeholder="Disabled input" aria-label="Disabled input example" disabled wire:model="armada">
                ...
                <div class="col">
                            ...
                            <td>
                                <div class="mb-3">
                                    <fieldset disabled>
                                        ...
                                        <input type="text" id="disabledTextInput" style="min-height: 60px; border-radius: 20px; background-color: #d6d6d6;" class="form-control" placeholder="Disabled input" wire:model="destinasi_provinsi">
                            ...
                            <td>
                                <div class="mb-3">
                                    <fieldset disabled>
                                        ...
                                        <input type="text" id="disabledTextInput" style="min-height: 60px; border-radius: 20px; background-color: #d6d6d6;" class="form-control" placeholder="Disabled input" wire:model="destinasi_kabupaten">
                            ...
                            <td>
                                <div class="mb-3">
                                    <fieldset disabled>
                                        ...
                                        <input type="text" id="disabledTextInput" style="min-height: 60px; border-radius: 20px; background-color: #d6d6d6;" class="form-control" placeholder="Disabled input" wire:model="destinasi_kecamatan">
                            ...
                            <td>
                                <div class="mb-3">
                                    <fieldset disabled>
                                        ...
                                        <input type="text" id="disabledTextInput" style="min-height: 60px; border-radius: 20px; background-color: #d6d6d6;" class="form-control" placeholder="Disabled input" wire:model="destinasi_kelurahan">
                    ...
                    <div class="mb-3">
                        ...
                        <select id="paket" class="form-select" style="min-height: 60px; border-radius: 20px;" wire:model="paket" wire:change="hitungHarga">
            ...
            <div class="row" style="margin-top: 100px;">
                <div class="col">
                    ...
                    <div class="mb-3">
                        <label for="floatingTextarea2">Detail Alamat</label>
                        <textarea class="form-control" placeholder="Masukan Detail Alamat Rumah Anda" placeholder="Masukan Detail Alamat Rumah Anda" id="" style="height: 150px; border-radius: 20px;" wire:model="detail_alamat_home"></textarea>
                        <span class="text-danger">@error('detail_alamat_home'){{ $message }}@enderror</span>
                    </div>

                    <div class="md-form md-outline input-with-post-icon datepicker" id="accLabels">
                        <label for="date">Rencana Kirim</label>
                        <input placeholder="Select date" type="date" id="date" style="min-height: 60px; border-radius: 20px;" class="form-control" placeholder="Pilih Jadwal Pengiriman" wire:model="rencana_kirim">
                        <i class="fas fa-calendar input-prefix" tabindex=0></i>
                        <span class="text-danger">@error('rencana_kirim'){{ $message }}@enderror</span>
                    </div>
                    <div class="mb-3">
                ...
                <div class="col">
                    ...
                    <div class="mb-3">
                        <label for="floatingTextarea2">Detail Alamat</label>
                        <textarea class="form-control" placeholder="Masukan Detail Alamat Kota Asal Anda" placeholder="Masukan Detail Alamat Kota Asal" id="" style="min-height: 150px; border-radius: 20px;" wire:model="detail_alamat_origin"></textarea>
                        <span class="text-danger">@error('detail_alamat_origin'){{ $message }}@enderror</span>
                    </div>
                    <table>
                        <tr>
